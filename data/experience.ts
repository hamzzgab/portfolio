...
export const experiences: Experience[] = [
  {
    ...
    bullets: [
      ...
      "Integrated LLM-powered keyword expansion into the Search Retargeting pipeline, optimising API throughput 25x (20 to 500+ concurrent calls/minute) through thread pool tuning, enabling automated segment enrichment that previously required manual keyword curation.",
